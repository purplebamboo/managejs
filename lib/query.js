		...
		var typeFunctionHash = {
			...
			ArrayExpression: {
				...
				splice: function() {
					...
					// var tmpIndex = 0;
					// while(tmpIndex < leftArgs[1]){
					// 	var tempObj = elements[leftArgs[0]+tmpIndex];
					// 	if(!tempObj.isNewNode){
					// 		_posUpdate(tempObj.start,tempObj.end,'');
					// 	}	
					// 	tmpIndex++;
					// }
					...
					//_posUpdate(tempObj.start,tempObj.end,returnArgs);
